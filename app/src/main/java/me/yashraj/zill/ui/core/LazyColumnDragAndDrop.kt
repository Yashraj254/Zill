...
internal constructor(
    ...
    internal fun startDragAtIndex(index: Int) {
...
fun LazyItemScope.DraggableItem(
    ...
    content: @Composable ColumnScope.(isDragging: Boolean, startDrag: () -> Unit) -> Unit,
) {
    ...
    Column(modifier = modifier.then(draggingModifier)) {
        content(dragging) { dragDropState.startDragAtIndex(index) }
    }
}